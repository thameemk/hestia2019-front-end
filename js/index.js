...
microParticle = function () {
  function microParticle(canvas, options) {_classCallCheck(this, microParticle);
    this.random = Math.random();
    this.random1 = Math.random();
    this.random2 = Math.random();
    this.progress = 0;
  ...
  }_createClass(microParticle, [{ key: "render", value: function render()
