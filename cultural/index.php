...
<div class="row event_listing_div"  style="text-align:left;padding-top: 10vh;">
    <div class="col-12 listing1" style="padding-bottom: 20px;">
              <p class="event-name text-light" style="letter-spacing: 3px;color:white;text-align: left;">DANCE</p>
              <p class="event-desc">Dance Description</p>
              <a href="#" class="details">MORE&nbsp;DETAILS</a>
            </div>
    <div class="col-12 listing1" style="padding-bottom: 20px;">
      <p class="event-name text-light" style="letter-spacing: 3px;text-align: left;">FILM & DRAMA</p>
      <p class="event-desc">Film & Drama Description</p>
      <a href="#" class="details">MORE&nbsp;DETAILS</a>
    </div>
    <div class="col-12 listing1" style="padding-bottom: 20px;">
      <p class="event-name text-light" style="letter-spacing: 3px;color:white;text-align: left;">MUSIC</p>
      <p class="event-desc">Music Description</p>
      <a href="#" class="details">MORE&nbsp;DETAILS</a>
    </div>
<div class="col-12 listing1" style="padding-bottom: 20px;">
<p class="event-name text-light" style="letter-spacing: 3px;text-align: left;">FINE ARTS</p>
<p class="event-desc">Fine Arts Description</p>
<a href="#" class="details">MORE&nbsp;DETAILS</a>
</div>
<div class="col-12 listing1" style="padding-bottom: 20px;">
<p class="event-name text-light" style="letter-spacing: 3px;text-align: left;">SPORTS</p>
<p class="event-desc">Sports Description</p>
<a href="#" class="details">MORE&nbsp;DETAILS</a>
</div>
<div class="col-12 listing1" style="padding-bottom: 20px;">
<p class="event-name text-light" style="letter-spacing: 3px;text-align: left;">LITERARY</p>
